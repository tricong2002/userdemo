!function () {
    "use strict";
    var t, e, a, n, s, o = localStorage.getItem("language"), l = "en";
    function i(e) {
        ...
        t && t.forEach(function (s) {
            !function t() {
                var e = +s.getAttribute("data-target")
                    ...
                    , n = e / 250;
                n < 1 && (n = 1),
                    a < e ? (s.innerText = (a + n).toFixed(0),
                        setTimeout(t, 1)) : s.innerText = e
            }()
        })
    }
    function r() {
        setTimeout(function () {
            ...
            n && (t = n.querySelector(".mm-active .active"),
    ...
    function c() {
        ...
        window.innerWidth <= 992 ? (document.getElementsByClassName("vertical-menu")[0].removeAttribute("style"),
            "horizontal" == document.body.getAttribute("data-layout") && (document.getElementsByClassName("vertical-menu")[0].style.display = "none")) : "vertical" == document.body.getAttribute("data-layout") && (document.getElementsByClassName("vertical-menu")[0].style.display = "block")
    }
    function u(t) {
    ...
    function m() {
        var t, e, a;
        feather.replace(),
            window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? "rtl" == document.getElementsByTagName("html")[0].style.direction ? sessionStorage.setItem("is_visited", "layout-direction-rtl") : null !== (e = document.querySelector("#" + t)) && (e.checked = !0,
                a = t,
    ...
    window.onload = function () {
        document.getElementById("preloader") && (u("pre-status"),
            u("preloader"))
    }
        ,
        m(),
            ...
            for (var t = document.getElementsByClassName("vertical-menu-btn"), a = 0; a < t.length; a++)
                t[a] && t[a].addEventListener("click", function (t) {
                    t.preventDefault(),
                        ...
                        992 <= window.innerWidth ? null == e ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == e ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm") : r()
                })
        }(),
        setTimeout(function () {
                ...
                t.href == l && (t.classList.add("active"),
                    (e = t.parentElement) && "side-menu" !== e.id && (e.classList.add("mm-active"),
                        (a = e.parentElement) && "side-menu" !== a.id && (a.classList.add("mm-show"),
                            (n = a.parentElement) && "side-menu" !== n.id && (n.classList.add("mm-active"),
                                (s = n.parentElement) && "side-menu" !== s.id && (s.classList.add("mm-show"),
                                    (o = s.parentElement) && "side-menu" !== o.id && o.classList.add("mm-active"))))))
            })
        }, 0),
        (t = document.querySelectorAll(".navbar-nav a")) && t.forEach(function (t) {
            var e, a, n, s, o, l, i = window.location.href.split(/[?#]/)[0];
            t.href == i && (t.classList.add("active"),
                (e = t.parentElement) && (e.classList.add("active"),
                    (a = e.parentElement).classList.add("active"),
                    (n = a.parentElement) && (n.classList.add("active"),
                        (s = n.parentElement) && (s.classList.add("active"),
                            (o = s.parentElement) && (o.classList.add("active"),
        ...
        (n = document.querySelectorAll(".light-dark")) && n.forEach(function (t) {
            t.addEventListener("click", function (t) {
                a.hasAttribute("data-layout-mode") && "dark" == a.getAttribute("data-layout-mode") ? (document.body.setAttribute("data-layout-mode", "light"),
                    "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "light")) : (document.body.setAttribute("data-layout-mode", "dark"),
                        "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "dark"))
            })
        }),
        a = document.body,
        ...
        (a = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout") ? (b("layout-horizontal"),
            ...
            document.getElementsByClassName("isvertical-topbar")[0].style.display = "none") : (b("layout-vertical"),
        ...
        a.hasAttribute("data-sidebar-size") && "sm" == a.getAttribute("data-sidebar-size") ? b("sidebar-size-small") : a.hasAttribute("data-sidebar-size") && "md" == a.getAttribute("data-sidebar-size") ? b("sidebar-size-compact") : b("sidebar-size-default"),
        a.hasAttribute("data-sidebar") && "brand" == a.getAttribute("data-sidebar") ? b("sidebar-color-brand") : a.hasAttribute("data-sidebar") && "dark" == a.getAttribute("data-sidebar") ? b("sidebar-color-dark") : b("sidebar-color-light"),
        ...
        document.querySelectorAll("input[name='layout'").forEach(function (t) {
            t.addEventListener("change", function (t) {
                t && t.target && "vertical" == t.target.value ? (b("layout-vertical"),
                    ...
                    document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "none",
                    document.getElementsByClassName("vertical-menu")[0].style.display = "block",
                    window.innerWidth <= 992 && document.getElementsByClassName("vertical-menu")[0].removeAttribute("style")) : (b("layout-horizontal"),
        ...
        document.querySelectorAll("input[name='layout-mode']").forEach(function (t) {
            t.addEventListener("change", function (t) {
                t && t.target && t.target.value && ("light" == t.target.value ? (document.body.setAttribute("data-layout-mode", "light"),
                    ...
                    b("sidebar-color-light")) : (document.body.setAttribute("data-layout-mode", "dark"),
                        document.body.setAttribute("data-topbar", "dark"),
                        document.body.setAttribute("data-sidebar", "dark"),
